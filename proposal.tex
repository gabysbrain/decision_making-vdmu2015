...
\emph{Perceptual studies} such as \ttwwarning{xxx} help us to better understand 
...
\begin{table}[tb]
  \begin{center}
    \caption{We coded the 21 papers listed in 
             Sedlmair et al.~\citep{Sedlmair:2014} for which decision making
             heuristics, if any, are employed.
    }
...
also set thresholds and filter out the unacceptable decisions. \tmnote{rather than filtering ... filtering?!?!}\ttwnote{rather than optimal ... unacceptable} This process
